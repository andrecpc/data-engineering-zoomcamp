...
with DAG(
    dag_id="data_ingestion_gcs_dag_hw2_yellow_taxi",
    ...
    local_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            "bucket": BUCKET,
            "object_name": f"raw/yellow_trip/{parquet_file}",
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": "external_table_yellow_trip",
            },
            "externalDataConfiguration": {
                "sourceFormat": "PARQUET",
                "sourceUris": [f"gs://{BUCKET}/raw/yellow_trip/{parquet_file}"],
            },
        },
    )
